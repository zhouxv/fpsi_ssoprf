...
# parameter values. Protocol 5 is fixed, and the timestamped CSV is always
...
Defaults:
  protocol=5 (fmap-offline), nn=(8 12 16), d=(2 6 10 15),
...
output_file="${SCRIPT_DIR}/fmap_offline_results_$(date +%Y%m%d_%H%M%S).csv"
